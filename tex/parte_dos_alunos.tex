...
1. \textbf{Transcrição:} DNA $\xrightarrow{k_{trans}}$ DNA + mRNA$_i$ (inibida por Proteína$_j$).
2. \textbf{Tradução:} mRNA$_i$ $\xrightarrow{k_{trad}}$ mRNA$_i$ + Proteína$_i$.
3. \textbf{Degradação de mRNA:} mRNA$_i$ $\xrightarrow{k_{dm}}$ $\emptyset$.
4. \textbf{Degradação de Proteína:} Proteína$_i$ $\xrightarrow{k_{dp}}$ $\emptyset$.
...
\begin{figure}[h]
    \centering
	\includegraphics[width=0.9\linewidth]{Figures/repressilator16runs.png}
